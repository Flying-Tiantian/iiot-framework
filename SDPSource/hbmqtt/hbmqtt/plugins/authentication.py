...
class FileAuthPlugin(BaseAuthPlugin):
    def __init__(self, context):
        ...
        self._name_as_password = self.auth_config.get('name-as-password', False)
    ...
    def authenticate(self, *args, **kwargs):
        ...
        if not authenticated:
            self.context.logger.warning("Unauthorized client: username %s" % session.username)
        return authenticated
